namespace GestionVentas.VISTA.ProductoVistas
{
	partial class ProductoListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			button1.Location = new Point(596, 50);
			...
			button4.Location = new Point(406, 50);
			...
			button3.Location = new Point(204, 50);
			...
			dataGridView1.Location = new Point(94, 148);
			dataGridView1.Margin = new Padding(3, 4, 3, 4);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.ReadOnly = true;
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.Size = new Size(579, 313);
			dataGridView1.TabIndex = 43;
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(690, -2);
			...
			pServicios.Location = new Point(592, 50);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 108);
			pServicios.TabIndex = 53;
